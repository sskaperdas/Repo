...
class GCNTransEModel(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim):
        super(GCNTransEModel, self).__init__()
        ...
        self.transE_entity_embeddings = tf.keras.layers.Embedding(
            num_entities, embedding_dim, name='transE_entity_embedding')
        self.transE_relation_embeddings = tf.keras.layers.Embedding(
            num_relations, embedding_dim, name='transE_relation_embedding')
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        concat_embed = tf.concat([s_embed, p_embed, o_embed, gcn_output_1, gcn_output_2,
                                  s_transE_embed, p_transE_embed, o_transE_embed], axis=1)
...
# Create and compile the model
model = GCNTransEModel(num_entities, num_relations, embedding_dim)
