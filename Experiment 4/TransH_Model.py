...
class GCN_GAT_TransH_Model_SigmoidLoss(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim, num_heads, dropout_rate=0.3):
        super(GCN_GAT_TransH_Model_SigmoidLoss, self).__init__()
        ...
        self.gcn_layers = []
        for _ in range(2):  # Add two GCN layers
...
model = GCN_GAT_TransH_Model_SigmoidLoss(num_entities, num_relations, embedding_dim, num_heads=4, dropout_rate=0.5)
