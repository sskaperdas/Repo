...
class GCN_TransH_Model(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim, projection_dim, dropout_rate=0.5, l2_reg=0.01):
        super(GCN_TransH_Model, self).__init__()
        ...
        self.gcn_layer1 = GCNLayer(256, activation='relu')
        self.gcn_layer2 = GCNLayer(128, activation='relu')
...
# Create and compile the model
model = GCN_TransH_Model(num_entities, num_relations, embedding_dim, projection_dim=embedding_dim)
