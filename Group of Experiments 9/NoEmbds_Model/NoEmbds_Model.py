...
class NoEmbds_GAT_Model(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim, dropout_rate=0.5, l2_reg=0.01, num_heads=4, gat_output_dim=256):
        super(NoEmbds_GAT_Model, self).__init__()
        ...
        # GAT Layer
        self.gat_layer = GATLayer(num_heads, gat_output_dim)
...
# Create and compile the model
model = NoEmbds_GAT_Model(num_entities, num_relations, embedding_dim)
