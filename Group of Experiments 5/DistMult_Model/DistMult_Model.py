...
class GAT_DistMult_Model(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # Compute the dot product of entity and relation embeddings
        dot_product = s_embed * p_embed * o_embed

        # Apply dropout
        x = self.dropout(dot_product, training=training)
...
model = GAT_DistMult_Model(num_entities, num_relations, embedding_dim, num_heads=4, dropout_rate=0.5)
