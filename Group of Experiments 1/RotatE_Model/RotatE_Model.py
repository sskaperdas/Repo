...
# Define the RotatE triple classification model with the dense architecture
class GCNRotatEModel_SigmoidLoss(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim):
        super(GCNRotatEModel_SigmoidLoss, self).__init__()
...
model = GCNRotatEModel_SigmoidLoss(num_entities, num_relations, embedding_dim)
