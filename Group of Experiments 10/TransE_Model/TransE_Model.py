...
class Model_With_TransE_GAT_GCN(tf.keras.Model):
    def __init__(self, num_entities, num_relations, embedding_dim, transE_dim, dropout_rate=0.5, l2_reg=0.01,
        ...
        super(Model_With_TransE_GAT_GCN, self).__init__()
...
# Create and compile the model
model = Model_With_TransE_GAT_GCN(num_entities, num_relations, embedding_dim, transE_dim)
