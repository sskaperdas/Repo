...
class ComplEx_Model(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        # Add degree and inverse relation frequency embeddings
        ...
        concat_embed = tf.concat([concat_embed, in_degree_embed, out_degree_embed, inverse_relation_frequency_embed], axis=1)
...
X_train_val, X_test, y_train_val, y_test = train_test_split(all_triples_with_degrees, labels, test_size=0.2, stratify=labels, random_state=42)
