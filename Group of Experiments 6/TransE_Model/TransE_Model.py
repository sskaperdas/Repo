...
model = GCN_GAT_TransE_Model(num_entities, num_relations, embedding_dim, num_heads=4, dropout_rate=0.5)
optimizer = tf.keras.optimizers.Adam(learning_rate=0.0001)
model.compile(optimizer=optimizer,
              loss=MarginRankingLoss(margin=1.2),
              metrics=['accuracy'])
